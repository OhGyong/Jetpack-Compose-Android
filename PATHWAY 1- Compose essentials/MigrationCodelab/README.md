...
이 프로젝트는 android-compose-codelabs의 [MigrationCodelab](https://github.com/googlecodelabs/android-compose-codelabs/tree/main/MigrationCodelab) 프로젝트를 바탕으로 Codelab에 맞춰 진행하였습니다.

## 1~3. Codelab 목표 및 설정(Introduction, Migration strategy, Getting set up)
